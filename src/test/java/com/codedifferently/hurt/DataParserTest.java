...
public class DataParserTest {
    ...
    public void testDataReader(){
        ...
        String expected = "{Apples=[0.25, Food, 1/23/2016, 2], " +
                           "Apples2=[0.23, Food, 5/02/2016, 2], " +
                           "Bread=[1.23, Food, 1/25/2016, 6], " +
                           "Cookies=[2.25, Food, 1/25/2016, 8], " +
                           "Error=[, , , 4], " +
                           "Milk=[3.23, Food, 1/17/2016, 5], " +
                           "Milk2=[1.23, Food, 4/25/2016, 1]}";
        String actual = parser.dataReader(rawData);
